...
public sealed class TopMoversTests
{
    ...
    private sealed class NoOpTestAi : IAiNarrativeService
    {
        ...
        public Task<NarrativeResult> SummarizeAsync(string instruction, IReadOnlyList<RiskRow> rows, SIAnalyzer.Core.Ai.Audience audience, SIAnalyzer.Core.Ai.DiffSummary? diff = null, CancellationToken ct = default)
