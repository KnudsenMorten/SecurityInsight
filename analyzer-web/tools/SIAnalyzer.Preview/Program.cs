...
// ===========================================================================
//  SIAnalyzer.Preview - generate the committed static exec-dashboard preview.
//  Usage: dotnet run --project tools/SIAnalyzer.Preview -- <seedJsonPath> <outHtmlPath> <chartJsPath>
...
string chartJs = args.Length > 2 ? args[2] : Path.Combine(repoRoot, "src", "SIAnalyzer.Web", "wwwroot", "lib", "chart.umd.js");
