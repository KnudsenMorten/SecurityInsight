...
<#
.SYNOPSIS
    Community VM launcher for PlatformConfiguration\Enable-VmManagedIdentity.
.DESCRIPTION
...
Write-Banner -Solution 'PlatformConfiguration' -Engine 'Enable-VmManagedIdentity' -Flavour 'community-vm' -Description 'Enable-VmManagedIdentity -- v2 ported engine under PlatformConfiguration.'
