...
<#
.SYNOPSIS
    Community Azure (Function / Logic App / Hybrid Worker) launcher for PlatformConfiguration\New-AzureFunctionHost.
.DESCRIPTION
...
Write-Banner -Solution 'PlatformConfiguration' -Engine 'New-AzureFunctionHost' -Flavour 'community-azure' -Description 'New-AzureFunctionHost -- v2 ported engine under PlatformConfiguration.'
