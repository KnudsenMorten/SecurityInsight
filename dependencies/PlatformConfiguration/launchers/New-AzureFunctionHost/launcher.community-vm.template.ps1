...
<#
.SYNOPSIS
    Community VM launcher for PlatformConfiguration\New-AzureFunctionHost.
.DESCRIPTION
...
Write-Banner -Solution 'PlatformConfiguration' -Engine 'New-AzureFunctionHost' -Flavour 'community-vm' -Description 'New-AzureFunctionHost -- v2 ported engine under PlatformConfiguration.'
