...
<#
.SYNOPSIS
    Community Azure (Function / Logic App / Hybrid Worker) launcher for PlatformConfiguration\New-EntraApp.
.DESCRIPTION
...
Write-Banner -Solution 'PlatformConfiguration' -Engine 'New-EntraApp' -Flavour 'community-azure' -Description 'New-EntraApp -- v2 ported engine under PlatformConfiguration.'
