...
<#
.SYNOPSIS
    Community VM launcher for PlatformConfiguration\New-EntraApp.
.DESCRIPTION
...
Write-Banner -Solution 'PlatformConfiguration' -Engine 'New-EntraApp' -Flavour 'community-vm' -Description 'New-EntraApp -- v2 ported engine under PlatformConfiguration.'
