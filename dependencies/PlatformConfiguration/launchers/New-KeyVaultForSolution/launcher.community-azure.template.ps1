...
<#
.SYNOPSIS
    Community Azure (Function / Logic App / Hybrid Worker) launcher for PlatformConfiguration\New-KeyVaultForSolution.
.DESCRIPTION
...
Write-Banner -Solution 'PlatformConfiguration' -Engine 'New-KeyVaultForSolution' -Flavour 'community-azure' -Description 'New-KeyVaultForSolution -- v2 ported engine under PlatformConfiguration.'
