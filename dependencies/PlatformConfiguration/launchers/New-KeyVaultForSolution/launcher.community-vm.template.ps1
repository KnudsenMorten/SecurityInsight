...
<#
.SYNOPSIS
    Community VM launcher for PlatformConfiguration\New-KeyVaultForSolution.
.DESCRIPTION
...
Write-Banner -Solution 'PlatformConfiguration' -Engine 'New-KeyVaultForSolution' -Flavour 'community-vm' -Description 'New-KeyVaultForSolution -- v2 ported engine under PlatformConfiguration.'
