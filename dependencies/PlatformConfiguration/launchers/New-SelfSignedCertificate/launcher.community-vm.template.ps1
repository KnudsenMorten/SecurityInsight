...
<#
.SYNOPSIS
    Community VM launcher for PlatformConfiguration\New-SelfSignedCertificate.
.DESCRIPTION
...
Write-Banner -Solution 'PlatformConfiguration' -Engine 'New-SelfSignedCertificate' -Flavour 'community-vm' -Description 'New-SelfSignedCertificate -- v2 ported engine under PlatformConfiguration.'
