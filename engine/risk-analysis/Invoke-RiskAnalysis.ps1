...
if ($ResultAll.Count -eq 0) {
    ...
    # RecommendedAction / Recommendation are NOT declared, so they depended on first-row
    # luck. That is the "remediation data missing" symptom, and it explains why it was
