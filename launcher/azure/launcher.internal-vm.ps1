...
.SYNOPSIS
    ...
    azure engine. Invokes Invoke-SIEngineRun -Engine azure.

.DESCRIPTION
    Runs the SecurityInsight asset-profiling azure engine on a platform-managed
...
Write-Banner -Solution 'SecurityInsight' -Engine 'AssetProfiling_Azure' -Flavour 'internal-vm' -Version $versionStamp
$global:SI_TranscriptPath = Start-SILauncherTranscript -Engine 'azure' -Flavour 'internal-vm' -RepoRoot $InstallPath
