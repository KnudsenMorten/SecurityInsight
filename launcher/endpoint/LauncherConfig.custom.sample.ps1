...
<#
.SYNOPSIS
    Quickstart customer config for SecurityInsight asset-profiling Endpoint engine.
...
# System prompt override for the Endpoint Classify call.
# $global:SI_SystemPrompt_endpoint = @'
# You are a security classifier...
# '@

# Activity / staleness window (days). Endpoints are flagged IsEnabledActive
# when MDE_LastSeen or EG.lastSeen is within this many days.
...
# the SI output workspace, set this to that workspace's resource ID.
# $global:SI_DefenderWorkspaceResourceId = '/subscriptions/<sub>/resourceGroups/<rg>/providers/Microsoft.OperationalInsights/workspaces/<name>'
