...
.SYNOPSIS
    ...
    endpoint engine. Invokes Invoke-SIEngineRun -Engine endpoint.

.DESCRIPTION
    Runs the SecurityInsight asset-profiling endpoint engine on a platform-managed
...
Write-Banner -Solution 'SecurityInsight' -Engine 'AssetProfiling_Endpoint' -Flavour 'internal-vm' -Version $versionStamp
$global:SI_TranscriptPath = Start-SILauncherTranscript -Engine 'endpoint' -Flavour 'internal-vm' -RepoRoot $InstallPath
