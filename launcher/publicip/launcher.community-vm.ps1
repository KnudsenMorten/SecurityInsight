...
<#
.SYNOPSIS
    Community VM launcher for SecurityInsight asset-profiling publicip engine.
    Invokes Invoke-SIEngineRun -Engine publicip.

.DESCRIPTION
    Runs the SecurityInsight asset-profiling publicip engine on a Windows box in
...
Write-Banner -Solution 'SecurityInsight' -Engine 'AssetProfiling_PublicIp' -Flavour 'community-vm' -Version $versionStamp
$global:SI_TranscriptPath = Start-SILauncherTranscript -Engine 'publicip' -Flavour 'community-vm' -RepoRoot $InstallPath
