...
# ============================================================================
# Bucketing knobs.
#   - UseQueryBucketing / DefaultBucketCount / BucketPlaceholderToken are
#     now hardcoded constants inside the engine and no longer settable here.
#   - AutoBucketCount still probes upward 1 -> 2 -> 4 -> 8 -> ... up to
#     AutoBucketMax until the query fits under the 30k-row Defender ceiling.
...
$global:AutoBucketCache        = $true    # skip probe if a working count is already cached
