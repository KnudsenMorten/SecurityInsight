...
<#
.SYNOPSIS
    Community VM launcher for SecurityInsight\CriticalAssetTagging.
.DESCRIPTION
    Runs the CriticalAssetTagging engine on a Windows box in the customer's own tenant.
...
Write-Banner -Solution 'SecurityInsight' -Engine 'CriticalAssetTagging' -Flavour 'community-vm' -Description 'CriticalAssetTagging -- v2 ported engine under SecurityInsight.'
