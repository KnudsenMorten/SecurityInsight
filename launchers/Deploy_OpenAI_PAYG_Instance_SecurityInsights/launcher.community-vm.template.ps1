...
<#
.SYNOPSIS
    Community VM launcher for SecurityInsight\Deploy_OpenAI_PAYG_Instance_SecurityInsights.
.DESCRIPTION
    Runs the Deploy_OpenAI_PAYG_Instance_SecurityInsights engine on a Windows box in the customer's own tenant.
