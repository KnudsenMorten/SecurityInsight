...
<#
.SYNOPSIS
    Community Azure (Function / Logic App / Hybrid Worker) launcher for SecurityInsight\IdentityAssetsCollectDefineTierIngestLog.
.DESCRIPTION
    Runs the IdentityAssetsCollectDefineTierIngestLog engine from an Azure host that has a system-assigned MI.
...
Write-Banner -Solution 'SecurityInsight' -Engine 'IdentityAssetsCollectDefineTierIngestLog' -Flavour 'community-azure' -Description 'IdentityAssetsCollectDefineTierIngestLog -- v2 ported engine under SecurityInsight.'
