...
# Az.Resources / Az.OperationalInsights / Az.Monitor / Az.Storage / AzLogDcrIngestPS
# are NOT pre-installed here -- the engine's Ensure-SecurityInsightModules call at
# the top of the .ps1 handles them (and the other engine dependencies) in one pass.
# Pre-installing them in the launcher was producing a duplicate "[MODULE] ... present"
# list right before the engine's own check. (v2.1.165 fix.)
