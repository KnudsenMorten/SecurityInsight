...
<#
.SYNOPSIS
    Community VM launcher for SecurityInsight\OnboardValidate-SecurityInsight-Permissions.
.DESCRIPTION
...
Write-Banner -Solution 'SecurityInsight' -Engine 'OnboardValidate-SecurityInsight-Permissions' -Flavour 'community-vm' -Version $versionStamp
