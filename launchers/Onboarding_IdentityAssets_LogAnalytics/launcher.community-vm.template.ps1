...
Write-Banner -Solution 'SecurityInsight' -Engine 'Onboarding_IdentityAssets_LogAnalytics' -Flavour 'community-vm' -Description 'Onboarding_IdentityAssets_LogAnalytics -- v2 ported engine under SecurityInsight.'
