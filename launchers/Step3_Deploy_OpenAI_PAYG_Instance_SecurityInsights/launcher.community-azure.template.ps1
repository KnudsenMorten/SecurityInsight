...
<#
.SYNOPSIS
    Community Azure (Function / Logic App / Hybrid Worker) launcher for SecurityInsight\Step3_Deploy_OpenAI_PAYG_Instance_SecurityInsights.
.DESCRIPTION
    Runs the Step3_Deploy_OpenAI_PAYG_Instance_SecurityInsights engine from an Azure host that has a system-assigned MI.
...
Write-Banner -Solution 'SecurityInsight' -Engine 'Step3_Deploy_OpenAI_PAYG_Instance_SecurityInsights' -Flavour 'community-azure' -Version $versionStamp
