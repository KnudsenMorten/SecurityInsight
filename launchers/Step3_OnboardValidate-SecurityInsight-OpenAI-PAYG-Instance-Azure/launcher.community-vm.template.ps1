...
<#
.SYNOPSIS
    Community VM launcher for SecurityInsight\Step3_OnboardValidate-SecurityInsight-OpenAI-PAYG-Instance-Azure.
.DESCRIPTION
    Runs the Step3_OnboardValidate-SecurityInsight-OpenAI-PAYG-Instance-Azure engine on a Windows box in the customer's own tenant.
...
Write-Banner -Solution 'SecurityInsight' -Engine 'Step3_OnboardValidate-SecurityInsight-OpenAI-PAYG-Instance-Azure' -Flavour 'community-vm' -Version $versionStamp
