...
<#
.SYNOPSIS
    Community VM launcher for SecurityInsight\UpdateSecurityInsight.
.DESCRIPTION
    Runs the UpdateSecurityInsight engine on a Windows box in the customer's own tenant.
...
Write-Banner -Solution 'SecurityInsight' -Engine 'UpdateSecurityInsight' -Flavour 'community-vm' -Description 'UpdateSecurityInsight -- v2 ported engine under SecurityInsight.'
