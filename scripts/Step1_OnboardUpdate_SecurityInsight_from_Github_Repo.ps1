...
.PARAMETER Engine
    ...
    'Step2_OnboardValidate-SecurityInsight-Permissions' to land ready to run.
...
.EXAMPLE
    ...
    .\Step1_OnboardUpdate_SecurityInsight_from_Github_Repo.ps1 -Engine Step2_OnboardValidate-SecurityInsight-Permissions
...
.EXAMPLE
    ...
    & $env:TEMP\Step0.ps1 -Engine Step2_OnboardValidate-SecurityInsight-Permissions

.EXAMPLE
    # Scheduled "keep up to date" run -- same command, idempotent:
    .\Step1_OnboardUpdate_SecurityInsight_from_Github_Repo.ps1
...
param(
    ...
    [string]$Engine          = '',                                         # <-- optional: launcher folder to cd into afterwards, e.g. 'Step2_OnboardValidate-SecurityInsight-Permissions'
...
try {
    ...
    elseif ($engineDirs.Count -eq 1) {
        ...
        Write-Host "  1. .\Step2_OnboardValidate-SecurityInsight-Permissions\launcher.community-vm.template.ps1" -ForegroundColor Yellow
        Write-Host "  2. .\Step3_OnboardValidate-SecurityInsight-LogAnalytics\launcher.community-vm.template.ps1" -ForegroundColor Yellow
        Write-Host "  3. (optional) .\Step4_OnboardValidate-SecurityInsight-OpenAI-PAYG-Instance-Azure\launcher.community-vm.template.ps1" -ForegroundColor Yellow
    }
}
finally {
