...
.PARAMETER PbixPath
    ...
    at TOOLS/PowerBI/SecurityInsight-RiskAnalysis.pbix. Override only if
...
if (-not $PbixPath) {
    $candidates = @(
        (Join-Path $PSScriptRoot '..\TOOLS\PowerBI\SecurityInsight-RiskAnalysis.pbix'),
        (Join-Path $PSScriptRoot '..\tools\PowerBI\SecurityInsight-RiskAnalysis.pbix')
    )
...
Power BI .pbix not found. Expected at:
  TOOLS/PowerBI/SecurityInsight-RiskAnalysis.pbix

If you haven't authored the .pbix yet, follow TOOLS/PowerBI/dashboard-spec.md
...
Write-Host "  LA workspace   : $LAWorkspaceId"                                                        -ForegroundColor Gray
Write-Host "  LA tenant      : $LATenantId"                                                           -ForegroundColor Gray
Write-Host "  Auth method    : $AuthMethod"                                                           -ForegroundColor Gray
Write-Host "  WhatIfMode     : $([bool]$WhatIfMode)"                                                  -ForegroundColor Gray
Write-Host "========================================================================================" -ForegroundColor Cyan
Write-Host ""
