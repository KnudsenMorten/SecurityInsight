...
$null = $sb.AppendLine("# Profiler engines (v2.2.245+). Custom values win over the SI_DcrNamePattern above --")
$null = $sb.AppendLine("# rename to unique values (e.g. 'dcr-si-endpoint-<tenant>') if same-named DCRs already")
$null = $sb.AppendLine("# exist in other subs/RGs visible to the SPN.")
$null = $sb.AppendLine("`$global:SI_Endpoint_DcrName              = 'dcr-si-endpoint'")
$null = $sb.AppendLine("`$global:SI_Identity_DcrName              = 'dcr-si-identity'")
$null = $sb.AppendLine("`$global:SI_Azure_DcrName                 = 'dcr-si-azure'")
$null = $sb.AppendLine("`$global:SI_PublicIp_DcrName              = 'dcr-si-publicip-profile'")
$null = $sb.AppendLine("# Non-profiler engines:")
